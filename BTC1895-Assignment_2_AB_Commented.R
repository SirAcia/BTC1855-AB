...
# Code comments by Zach, marked by comments beginning with "ZC"
...
# ZC - liked the note on choice of function, tried using quit() and lost half of my code before switching to another function. 
...
# ZC - Good use of commenting for readability in the if, else snippet 
...
# ZC - just a thought for next time, think about how you can "idiot-proof" your code (i.e. steps for if I enter more 
# than 3 numbers or negative numbers which return slightly odd results unaccounted for errors), but overall it's really good & cleaner than mine! 